...
export default function SplashScreen({ onComplete }: { onComplete: () => void }) {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-background-light dark:bg-background-dark overflow-hidden p-6 transition-colors duration-300">
      ...
      >
        <div className="w-full aspect-square relative group">
          ...
          <div className="w-full h-full rounded-3xl overflow-hidden border border-slate-200 dark:border-primary/20 bg-white dark:bg-background-dark shadow-2xl shadow-primary/10">
            <img
        ...
        <div className="text-center space-y-2">
          <h1 className="text-slate-900 dark:text-white tracking-tighter text-[48px] font-bold leading-none">
