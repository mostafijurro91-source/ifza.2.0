...
export default function Orders({ setScreen, orders }: { setScreen: (s: Screen) => void, orders: Order[] }) {
  return (
    <div className="relative flex h-[100dvh] w-full flex-col bg-background-dark text-white overflow-hidden">
              ...
              <div className="bg-primary/5 border border-primary/10 rounded-2xl p-5">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-base font-bold text-white">{orders[0].id}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] uppercase tracking-wider text-primary/40 font-bold mb-1">Date</p>
                    <p className="text-base font-bold text-white">{orders[0].date}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-white">{orders[0].items[0].name}</p>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-background-dark border-t border-primary/10 pb-8 pt-3 px-6 flex justify-between items-center z-50">
