...
export default function AdminLogin({ setScreen, onAdminLogin }: { setScreen: (s: Screen) => void, onAdminLogin: (user: string, pass: string) => boolean }) {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[#0a0a0f] text-white p-6 justify-center">
      <button 
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-4 focus:outline-none focus:border-blue-500 transition-colors text-sm"
